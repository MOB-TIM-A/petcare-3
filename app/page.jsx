...
const testimonials = [
  {
    id: 1,
    name: "John Doe",
    message: "Amazing service! My pet is always happy and well-cared for.",
  },
  {
    id: 2,
    name: "Jane Smith",
    message: "The staff is incredibly professional and caring. Highly recommended!",

  },
  {
    id: 3,
    name: "Mike Johnson",
    message: "Best pet care facility in town. My dog loves it here!",
  },
  {
    id: 4,
    name: "Mike Johnson",
...
return (
  <>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
      ...
      <img src="./assets/line1.svg" alt="" className="max-w-45 md:max-w-59.75 ml-[15%] md:ml-[25%] mb-10 md:mb-20" />
      <h1 className="text-3xl sm:text-4xl md:text-6xl font-medium animate-slide-out-bottom animate-once ">
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="flex items-center animate-spin-5s">
        <img className="w-8 h-8 mr-2 " src="./assets/label-icon.svg" alt="Grooming Service" />
        <p className="text-lg font-semibold">Grooming Service</p>
      </div>
      <div className="flex items-center">
        <img className="w-8 h-8 mr-2 " src="./assets/label-icon.svg" alt="Veterinary Support" />
        <p className="text-lg font-semibold">Veterinary Support</p>
      </div>
      <div className="flex items-center">
        <img className="w-8 h-8 mr-2 " src="./assets/label-icon.svg" alt="Pet Adoption" />
        <p className="text-lg font-semibold">Pet Adoption</p>
      </div>
      <div className="flex items-center">
        <img className="w-8 h-8 mr-2 " src="./assets/label-icon.svg" alt="Boarding" />
        <p className="text-lg font-semibold">Boarding</p>
      </div>
      <div className="flex items-center">
        <img className="w-8 h-8 mr-2 " src="./assets/label-icon.svg" alt="Pet Daycare" />
        <p className="text-lg font-semibold">Pet Daycare</p>
      </div>
      <div className="flex items-center">
        <img className="w-8 h-8 mr-2 " src="./assets/label-icon.svg" alt="Pet Supplies" />
    ...
    <div className="py-22 flex flex-col gap-8">
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium text-left ">
      The Best Facilities are Here
      </h2>
      <p>
      We provide top-notch facilities to ensure your pets receive the best care
      </p>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      <div className="relative h-72 sm:h-96 lg:h-129">
        <img src="./assets/fac-image1.png" alt="" className="w-full h-full object-cover rounded-2xl hover:opacity-90 hover:border-amber-500 transition-all duration-300 cursor-pointer" />
      ...
      <div className="relative h-72 sm:h-96 lg:h-129">
        <img src="./assets/fac-image2.png" alt="" className="w-full h-full object-cover rounded-2xl hover:opacity-90 hover:border-amber-500 transition-all duration-300 cursor-pointer" />
        <div className="px-6 py-3 bg-white border border-[#1B1B1B] text-[#1B1B1B] rounded-full absolute top-4 left-4 ">
        Boarding Facilities
        </div>
      </div>
      <div className="relative h-72 sm:h-96 lg:h-129">
        <img src="./assets/fac-image3.png" alt="" className="w-full h-full object-cover rounded-2xl hover:opacity-90 hover:border-amber-500 transition-all duration-300 cursor-pointer" />
        <div className="px-6 py-3 bg-white border border-[#1B1B1B] text-[#1B1B1B] rounded-full absolute top-4 left-4 ">
        Pet Spa
        </div>
      </div>
      <div className="relative h-72 sm:h-96 lg:h-129">
        <img src="./assets/fac-image4.png" alt="" className="w-full h-full object-cover rounded-2xl hover:opacity-90 hover:border-amber-500 transition-all duration-300 cursor-pointer" />
        <div className="px-6 py-3 bg-white border border-[#1B1B1B] text-[#1B1B1B] rounded-full absolute top-4 left-4 ">
        Play Zone
        </div>
      </div>
    ...
    <div className="pt-12 flex flex-col lg:flex-row justify-center items-center max-w-7xl mx-auto px-4">
      ...
      src="./assets/img1.png"
      alt=""
      className="w-98 max-w-xs sm:max-w-md md:max-w-lg lg:max-w-119 mx-auto lg:mx-0"
      />
      <div className="flex flex-col w-full lg:w-auto mt-8 lg:mt-0 lg:ml-12">
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium text-center lg:text-left ">
        Our Check-in Time
      </h2>
      <div className="flex flex-col md:flex-row gap-6 md:gap-10 mt-8 md:mt-25 items-center lg:items-start justify-center">
        <div className="py-8 px-4 sm:py-10 sm:px-6 box-shadow rounded-3xl bg-white w-full max-w-xs sm:max-w-sm md:w-75.5">
        <img
        ...
        <div className="py-8 px-4 sm:py-10 sm:px-6 rounded-3xl bg-white w-full max-w-xs sm:max-w-sm md:w-75.5">
        <img
      ...
      <div className="max-w-7xl mx-auto px-4 mt-20">
        ...
        <div className="relative max-w-4xl mx-auto p-8 bg-gray-100 rounded-lg shadow-lg">
          {/* Kontainer Slideshow */}
          <div className="overflow-hidden">
            ...
            >
              {testimonials.map((testimonial) => (
                <div
                  key={testimonial.id}
                  className="shrink-0 w-full flex flex-col items-center text-center p-6"
                >
                  <h3 className="text-sm font-semibold text-gray-900 border rounded-full px-4 py-3 mb-2 bg-amber-50">
                    {testimonial.name}
                  </h3>
                  {/* Pesan Testimonial */}
          ...
          <button
            onClick={handlePrev}
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white p-3 rounded-full shadow-md hover:bg-amber-500 transition-colors"
          ...
          <button
            onClick={handleNext}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white p-3 rounded-full shadow-md hover:bg-amber-500 transition-colors"
